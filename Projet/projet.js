document.addEventListener("DOMContentLoaded",()=>{
    const description = {
        ...
        "html.png":"Ce projet consistait à créer une page web en utilisant HTML et CSS. Nous avons utilisé des balises HTML pour structurer le contenu de la page, et du CSS pour styliser les éléments. Le projet a permis de mettre en pratique les concepts de base du développement web, tels que la mise en page, les couleurs, les polices, et les images.",
